...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    axios
      .post("http://localhost:4001/getdoctor", { id: userId })
      .then((response) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-800 to-blue-400 flex items-center justify-center p-4">
      <div className="bg-white shadow-2xl rounded-lg p-8 w-full max-w-3xl">
        ...
        <div className="flex flex-col md:flex-row justify-around space-y-4 md:space-y-0">
          <Link to="/ViewPatientAppointment">
            <button className="bg-green-500 text-white py-3 px-12 rounded-lg shadow-md hover:bg-green-600 transition">
              View Appointments
            </button>
          </Link>
          <Link to="/AddPrescription">
          <button className="bg-purple-500 text-white py-3 px-12 rounded-lg shadow-md hover:bg-purple-600 transition">
            Add Prescriptions
          </button>
          </Link>
          <button
            className="bg-red-500 text-white py-3 px-12 rounded-lg shadow-md hover:bg-red-600 transition"
